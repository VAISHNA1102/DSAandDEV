...
const Info = () => {
  return (
    <div className='flex flex-col justify-center items-center mt-24'>
        <div className='text-2xl inconsolataFontFamily text-gray-300 md:4xl'>About us</div>
        <div className='text-white flex flex-col gap-y-10 mt-6 md:m-8'>
            ...
            <div className='glass flex flex-col md:flex-row w-10/12 mx-auto justify-center items-center rounded-2xl md:w-10/12 md:rounded-2xl'>
                <div>
                    <img src={imgDsa} alt="Img not found" className='rounded-t-2xl md:hidden'/>
                </div>
                <div className='rounded-b-2xl md:rounded-2xl dark:hover:bg-gradient-to-r from-purple-300 to-blue-700 hover:text-black cursor-pointer'>
            ...
            <div className='glass flex flex-col md:flex-row w-10/12 mx-auto justify-center items-center rounded-2xl md:w-10/12 md:rounded-2xl'>
                <img src={imgDev} alt="Img not found" className='rounded-t-2xl md:hidden'/>
                <div className='rounded-b-2xl md:rounded-2xl dark:hover:bg-gradient-to-r from-purple-300 to-blue-700 hover:text-black cursor-pointer'>
                    <div className='text-2xl font-bold text-center my-2 md:text-3xl'>Welcome to Web Development Learning</div>
                    <div className='text-center text-sm my-1 w-11/12 mx-auto md:text-lg'>Master Web Development,Explore tutorials in HTML, CSS, and JavaScript. </div>
                    <div className='text-2xl font-semibold mt-6 mb-2 text-center md:text-3xl'>Our platform offers:</div>
                    <ul className='w-9/12 mx-auto flex flex-col gap-y-1 list-disc justify-center'>
                        <li className=''><span className='font-bold'>Expert Tutorials :</span> Simplified explanations and real-world examples.</li>

                    ...
                    <form>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" id="name" placeholder="Enter your name" className="p-2 sm:p-3 rounded-lg bg-gray-700 font-normal text-sm sm:text-base md:text-lg text-white outline-2 w-full" />
                            </div>
                            <div>
                                <label htmlFor="email" className="block mb-1 text-slate-300">Email<span className="text-red-500 m-1">*</span></label>
                                <input type="email" id="email" placeholder="Enter your email" className="p-2 sm:p-3 rounded-lg bg-gray-700 font-normal text-sm sm:text-base md:text-lg text-white outline-2 w-full" />
                            </div>
                        </div>
                        <div className="mb-4">
                            <label htmlFor="phone" className="block mb-1 text-slate-300">Phone Number<span className="text-red-500 m-1">*</span></label>
                            <input type="tel" id="phone" placeholder="Enter your Phone Number" className="p-2 sm:p-3 rounded-lg bg-gray-700 font-normal text-sm sm:text-base md:text-lg text-white outline-2 w-full" />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="message" className="block mb-1 text-slate-300">Message<span className="text-red-500 m-1">*</span></label>
                            <textarea id="message" rows="4" placeholder="Enter your message" className="p-2 sm:p-3 rounded-lg bg-gray-700 font-normal text-sm sm:text-base md:text-lg text-white outline-2 w-full"></textarea>
                        </div>
                        <button type="submit" className="bg-blue-300 text-black px-4 py-2 rounded-md flex items-center font-bold mt-4 hover:bg-blue-500 hover:text-white">
                            Submit
                        </button>
                    </form>
                </div>
                <div className="w-full md:w-1/3 bg-blue-700 p-6 md:p-8 flex flex-col justify-between border-2 border-slate-600 rounded-lg">

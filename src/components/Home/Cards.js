...
function Cards() {
  return (
    <div className='flex flex-col mt-5 md:flex-row md:px-2 lg:w-9/12 md:mx-auto md:gap-x-10'>
        <div className='flex flex-col w-8/12 mx-auto bg-gray-950 justify-center items-center rounded-2xl h-80 mt-5 glass dark:hover:bg-gradient-to-r from-purple-300 to-blue-700 hover:text-black'>
